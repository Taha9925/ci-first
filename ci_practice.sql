...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 07, 2019 at 08:23 AM
...
INSERT INTO `user` (`id`, `first_name`, `last_name`, `dob`, `email`, `mobile`, `gender`, `address`, `state`, `city`, `password`, `status`, `createdat`) VALUES
(1, 'Taha', 'Sethwala', '1996-01-14', 'taha@hmmbiz.com', 9925738146, 'Male', 'A/4, Unit Hills, Near Union Park Society, Juhapura', 'Gujarat', 'Ahmedabad', '599394c19b831b9957634a9ea1d444a2', 'Active', '2019-05-29');
